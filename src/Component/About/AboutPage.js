    ...
    return (
      <div className="about_page">
        ...
        <div className="about_right">
          ...
          <p>
            Through the income page, the spreading page, and the reporting page,
          ...
          <h3>Contact Me!!</h3>
          <p>
            If you have any further questions on the site, please contact Me
            here!
          </p>
          <br />
          &nbsp;
          ...
          &nbsp;
          <SocialIcon
            url="https://www.linkedin.com/in/hyunwoomoon/"
            target="_blank"
            className="contact_icon"
          />
          &nbsp;
          <SocialIcon
            url="https://github.com/HyunwooMoon-developer"
            target="_blank"
            className="contact_icon"
          />
        </div>
